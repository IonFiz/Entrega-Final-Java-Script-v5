...
audioIcon.innerHTML= `
    <img id="audio" src="./aseets/images/icons8-volumen-alto-30.png"/>
`;

let toggle = false;
function changeAudioIcon() {
    if (toggle === true) {
        document.getElementById('audio').src  = './assets/images/icons8-volumen-alto-30.png'; 
    } else {
       document.getElementById('audio').src = './assets/images/icons8-mudo-30.png';
    }
    toggle = !toggle; 
}
